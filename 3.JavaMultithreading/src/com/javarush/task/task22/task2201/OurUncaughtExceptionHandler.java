...
public class OurUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    protected String getFormattedStringForFirstThread(Thread t, Throwable e, String string) {
        /*String getClassFirst = e.getClass().toString();
        getClassFirst = getClassFirst.substring(getClassFirst.indexOf("S"));*/

//        return String.format(string, t.getName(), getClassFirst, e.getSuppressed());
